                                ...
                                <div class="col-xl-6">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-2 mt-2">
                                            <button class="btn btn-primary" type="submit" id="export_submit_button">Cari</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\wbs\resources\views/admin/complaint/report.blade.php ENDPATH**/ ?>